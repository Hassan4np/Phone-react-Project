    ...
    return (
        ...
        <div className="flex items-center text-gray-900">
          ...
          <ul className="ml-auto mr-8 hidden items-center gap-6 lg:flex">
            <NavLink to="/"><li className="block p-1 font-sans text-sm font-normal leading-normal text-inherit antialiased">
              <a className="flex items-center" href="#">
                Home
              </a>
            </li></NavLink>
            <NavLink to="/selectPhone"><li className="block p-1 font-sans text-sm font-normal leading-normal text-inherit antialiased">
              <a className="flex items-center" href="#">
                Select Phone
              </a>
            </li></NavLink>
            <NavLink to="/login"><li className="block p-1 font-sans text-sm font-normal leading-normal text-inherit antialiased">
              <a className="flex items-center" href="#">
                Login
              </a>
            </li></NavLink>
